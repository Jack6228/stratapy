...
.. tip::
   You can follow along with the tutorial and the rest of the documentation using the complimentary Jupyter notebooks which you can `download here <https://github.com/your-repo/notebooks>`_.
...
.. card:: Get Started
   :link: file_format.html
   :link-type: url
   :width: 50%
   :text-align: center

   Learn how to format your data file and create your first log
...
.. figure:: /_static/figures/Tutorial.png
   ...
   Example log which you will learn to create in this tutorial.
